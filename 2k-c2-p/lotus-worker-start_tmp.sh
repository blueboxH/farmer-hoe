...
LOTUS_SOURCE_2K=/root/lotus-2k
LOTUS_PATH_WORKER_2K=/filecoin
export MINER_STORAGE_PATH=/nfs/lotusminer_public_2k
export MINER_API_INFO=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJBbGxvdyI6WyJyZWFkIiwid3JpdGUiLCJzaWduIiwiYWRtaW4iXX0.BHOwOY5xyh1yk7f53maHSazT1exiZfbkGnMwJm6Mu_4:/ip4/25.10.10.73/tcp/2345/http
...
scp root@25.10.10.73:${LOTUS_SOURCE_2K}/lotus-worker ${LOTUS_PATH_WORKER_BIN}/lotus-worker
